...
//
//     return Container(
//       padding: ResponsiveHelper.isDesktop(context) ? const EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL) : null,
...
//           color: Get.isDarkMode? Colors.grey.shade700 : Colors.grey.shade300, spreadRadius: 1, blurRadius: 5,
//         )] : null,
//       ),
//       child: Column(
...
//
//                     !isStore ? RatingBar(rating: 0, size: _desktop ? 15 : 12, ratingCount: 0) : const SizedBox(),
//                     isStore ? RatingBar(
...
//             ),
//           ),
//           _desktop ? const SizedBox() : Padding(
