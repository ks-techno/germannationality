...
class CategoryController extends GetxController implements GetxService {
  ...
  Future<Map<String,dynamic>> fetchCategories({bool isFromInitState=false}) async {
    ...
    Map<String,dynamic> response = await categoryRepo.getCategories(language: userInfoModel!= null? userInfoModel.translationLanguage!.languageName.toLowerCase() :Get.find<AuthController>().authRepo.getSelectedLanguage()['language'].toString().toLowerCase());
