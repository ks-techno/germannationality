// import 'dart:convert';
//
// import 'package:glow_solar/data/model/response/address_model.dart';
...
//     required String flatUnit,
//     required String floor,
//     required String phaseArea,
//     bool hasLift = false,
//   }) {
//     this._cart = cart;
...
//     this._flatUnit = flatUnit;
//     this._floor = floor;
//     this._phaseArea = phaseArea;
//     this._hasLift = hasLift;
//   }
//
...
//   String get flatUnit => _flatUnit;
//   String get floor => _floor;
//   String get phaseArea => _phaseArea;
//   bool get hasLift => _hasLift;
//
...
//     _buildingName = json['house'];
//     _flatUnit = json['flat'];
//     _floor = json['floor'];
//     _phaseArea = json['estate_or_phase'];
//     _hasLift = json['is_lift'] == "1" ? true : false;
//   }
//
...
//     data['house'] = this._buildingName;
//     data['flat'] = this._flatUnit;
//     data['floor'] = this._floor;
//     data['estate_or_phase'] = this._phaseArea;
//     data['is_lift'] = this._hasLift ? "1" : "0";
//     return data;
//   }
// }
//
